...
<body>
<h2>Fresh 1 & 1.5 L Bisleryr</h2>
<div class="imagediv">
    <img src="image9.jpg" alt="water image">
</div>
<div class="maindiv">
    <div class="pricediv">
        <p>Price: ₹<span id="totalPrice">30</span></p>
    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    purchaseBtn.addEventListener('click', function() {
        ...
        xhr.open('POST', 'shopping4.php', true);
        xhr.send(formData);
    });

    function updatePrice() {
      var quantity = parseInt(quantityInput.value);
      var totalPrice = quantity * 30; // Each item costs ₹70
