...
<div class="imagediv">
    <img src="image11.jpg" alt="water image">
</div>
<div class="maindiv">
    <div class="pricediv">
        <p>Price: ₹<span id="totalPrice">230</span></p>
    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    purchaseBtn.addEventListener('click', function() {
        ...
        xhr.open('POST', 'shopping6.php', true);
        xhr.send(formData);
    });

    function updatePrice() {
      var quantity = parseInt(quantityInput.value);
      var totalPrice = quantity * 230; // Each item costs ₹70
